...
export const getDifficultyOptions = (colors: Colors): DifficultyOption[] => [
...
export const getDifficultyConfig = (colors: Colors): Record<Difficulty, { label: string; color: string; bgColor: string }> => ({
